...
import { serializeForm, formPostValidation, apiCall, getType, convertObjectKeys } from "@coolblue/js-helpers";
import { useDebounce } from "@coolblue/react-hooks";
import Loading from "@coolblue/ui-library/Loading";

import styles from "./resources/styles/form.module.scss";

const InputTypeText = loadable(() => import(/* webpackChunkName: "InputTypeText" */ "@coolblue/ui-library/FormElements/InputfieldText"), {
    fallback: <Loading />,
});
